...
import { SChlist } from "./chlist.entity";

  //import { STypeUnit } from "./STypeUnit";
 // import { SChlistTnpa } from "./SChlistTnpa";
  ...
  export class SChlistForm {
    ...
    @ManyToOne(() => SChlist, (sChlist) => sChlist.sChlistForms, {
      onDelete: "NO ACTION",
      onUpdate: "CASCADE",
    })
    @JoinColumn([{ name: "id_chlist", referencedColumnName: "idChlist" }])
    idChlist2: SChlist;
  
   /*  @ManyToOne(() => STypeUnit, (sTypeUnit) => sTypeUnit.sChlistForms, {
      onDelete: "NO ACTION",
      onUpdate: "CASCADE",
    })
    @JoinColumn([{ name: "id_type_unit1", referencedColumnName: "idTypeUnit" }])
    idTypeUnit: STypeUnit; */
  
   /*  @ManyToOne(() => STypeUnit, (sTypeUnit) => sTypeUnit.sChlistForms2, {
      onDelete: "NO ACTION",
      onUpdate: "CASCADE",
    })
    @JoinColumn([{ name: "id_type_unit2", referencedColumnName: "idTypeUnit" }])
    idTypeUnit4: STypeUnit; */
  
   /*  @ManyToOne(() => STypeUnit, (sTypeUnit) => sTypeUnit.sChlistForms3, {
      onDelete: "NO ACTION",
      onUpdate: "CASCADE",
    })
    @JoinColumn([{ name: "id_type_unit3", referencedColumnName: "idTypeUnit" }])
    idTypeUnit5: STypeUnit;
  
    @ManyToOne(() => STypeUnit, (sTypeUnit) => sTypeUnit.sChlistForms4, {
      onDelete: "NO ACTION",
      onUpdate: "CASCADE",
    })
    @JoinColumn([{ name: "id_type_unit4_6", referencedColumnName: "idTypeUnit" }])
    idTypeUnit4_2: STypeUnit;
  
    @ManyToOne(() => STypeUnit, (sTypeUnit) => sTypeUnit.sChlistForms5, {
      onDelete: "NO ACTION",
      onUpdate: "CASCADE",
    })
    @JoinColumn([{ name: "id_type_unit7", referencedColumnName: "idTypeUnit" }])
    idTypeUnit6: STypeUnit;
