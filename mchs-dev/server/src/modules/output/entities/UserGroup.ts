...
export class UserGroup {
  ...
  @Column("tinyint", {
    ...
    nullable: true,
    comment:
      "0-должн.лицо, направившее чек-лист,1-руководитель группы,2-исполнитель,3-Гл.государтвенный инспектор региона по пожарному надзору,4-Государтвенный инспектор региона по пожарному надзору",
  })
