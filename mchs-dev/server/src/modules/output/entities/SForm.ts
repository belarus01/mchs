...
import { SDefection1 } from "./SDefection1";
import { SDefection2 } from "./SDefection2";
...
export class SForm {
  ...
  @OneToMany(() => SDefection1, (sDefection1) => sDefection1.idForm2)
  sDefections2: SDefection1[];

  @OneToMany(() => SDefection2, (sDefection2) => sDefection2.idForm2)
  sDefections3: SDefection2[];
