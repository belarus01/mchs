...
@Index("UK_s_defection2", ["idTnpa", "numReg", "idForm", "org"], {
  unique: true,
})
@Index("FK_s_defection2_id_form", ["idForm"], {})
@Entity("s_defection2", { schema: "doc" })
export class SDefection2 {
  ...
  @ManyToOne(() => SForm, (sForm) => sForm.sDefections3, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
