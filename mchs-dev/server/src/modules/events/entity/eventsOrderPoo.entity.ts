import { SPoo } from "src/modules/poo/entity/poo.entity";
import {
    Column,
    Entity,
    Index,
  ...
  export class SEventsOrderPoo {
    ...
    @ManyToOne(() => SPoo, (sPoo) => sPoo.sEventsOrderPoos, {
      onDelete: "NO ACTION",
      onUpdate: "CASCADE",
    })
    @JoinColumn([{ name: "id_poo", referencedColumnName: "idPoo" }])
    idPoo2: SPoo;
  }
