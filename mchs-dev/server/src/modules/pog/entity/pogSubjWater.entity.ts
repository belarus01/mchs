...
@Index("FK_s_pog_subj_water_id_subj", ["idSubj"], {})
@Index("FK_s_pog_subj_water_id_subj_obj", ["idSubjObj"], {})
@Entity("s_pog_subj_water", { schema: "mchs" })
export class SPogSubjWater {
  ...
  @ManyToOne(() => SSubj, (sSubj) => sSubj.sPogSubjWaters, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
  ...
  @ManyToOne(() => SSubjObj, (sSubjObj) => sSubjObj.sPogSubjWaters, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
