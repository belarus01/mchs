...
@Index("FK_s_pog_subj_avia_id_subj", ["idSubj"], {})
@Index("FK_s_pog_subj_avia_id_subj_obj", ["idSubjObj"], {})
@Entity("s_pog_subj_avia", { schema: "mchs" })
export class SPogSubjAvia {
  ...
  @ManyToOne(() => SSubj, (sSubj) => sSubj.sPogSubjAvias, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
  ...
  @ManyToOne(() => SSubjObj, (sSubjObj) => sSubjObj.sPogSubjAvias, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
