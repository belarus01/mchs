...
@Index("FK_s_poo_subj_pb_id_subj", ["idSubj"], {})
@Entity("s_poo_subj_pb", { schema: "mchs" })
export class SPooSubjPb {
  ...
  @ManyToOne(() => SSubj, (sSubj) => sSubj.sPooSubjPbs, {
    onDelete: "NO ACTION",
    onUpdate: "CASCADE",
  })
  ...
  @ManyToOne(() => SSubjObj, (sSubjObj) => sSubjObj.sPooSubjPbs, {
    onDelete: "NO ACTION",
    onUpdate: "CASCADE",
  })
