...
@Entity("s_sopb_card", { schema: "mchs" })
export class SSopbCard {
  ...
  @ManyToOne(() => SDept, (sDept) => sDept.sSopbCards, {
    onDelete: "NO ACTION",
    onUpdate: "CASCADE",
  })
  @JoinColumn([{ name: "id_dept_request", referencedColumnName: "idDept" }])
  idDeptRequest2: SDept;
  ...
  @ManyToOne(() => User, (users) => users.sSopbCards, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
